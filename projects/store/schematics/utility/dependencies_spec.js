...
describe('dependencies', () => {
    describe('addDependency', () => {
        ...
        [
            ...
            describe(`Type: ${type.toString()}`, () => {
                ...
                it('should handle an existing dependency (update version)', () => {
                    (0, dependencies_1.addPackageJsonDependency)(tree, { ...dependency, version: '0.0.0' });
                    (0, dependencies_1.addPackageJsonDependency)(tree, { ...dependency, overwrite: true });
                    const pkgJson = JSON.parse(tree.readContent(pkgJsonPath));
                    expect(pkgJson[type.key][dependency.name]).toEqual(dependency.version);
                });
            });
        ...
        it('should throw when missing package.json', () => {
            expect(() => (0, dependencies_1.addPackageJsonDependency)(new schematics_1.EmptyTree(), dependency)).toThrow();
        });
    });
    describe('getDependency', () => {
        ...
        it('should get a dependency', () => {
            const dep = (0, dependencies_1.getPackageJsonDependency)(tree, 'my-pkg');
        ...
        it('should return null if dependency does not exist', () => {
            const dep = (0, dependencies_1.getPackageJsonDependency)(tree, 'missing-pkg');
            expect(dep).toBeNull();
        });
    });
});
