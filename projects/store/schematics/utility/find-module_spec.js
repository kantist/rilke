...
describe('find-module', () => {
    describe('findModule', () => {
        ...
        it('should find a module', () => {
            const foundModule = (0, find_module_1.findModule)(host, 'foo/src/app/bar');
        ...
        it('should throw if no modules found', () => {
            ...
            expect(() => (0, find_module_1.findModule)(host, 'foo/src/app/bar')).toThrowError(/More than one module matches/);
        });
        it('should throw if only routing modules were found', () => {
            ...
            expect(() => (0, find_module_1.findModule)(host, 'foo/src/app/anything-routing')).toThrowError(/Could not find a non Routing NgModule/);
        });
        it('should throw if two modules found', () => {
            host = new schematics_1.EmptyTree();
            expect(() => (0, find_module_1.findModule)(host, 'foo/src/app/bar')).toThrowError(/Could not find an NgModule/);
        });
        it('should accept custom ext for module', () => {
            ...
            const foundModule = (0, find_module_1.findModule)(host, 'foo/src/app/bar', '_module.ts');
            expect(foundModule).toBe(modulePath);
            // Should not find module if using default ext
            expect(() => (0, find_module_1.findModule)(host, 'foo/src/app/bar')).toThrowError(/Could not find an NgModule/);
        });
        it('should not find module if ext is invalid', () => {
            expect(() => (0, find_module_1.findModule)(host, 'foo/src/app/bar', '-module.ts')).toThrowError(/Could not find an NgModule/);
            expect(() => (0, find_module_1.findModule)(host, 'foo/src/app/bar', '_module.ts')).toThrowError(/Could not find an NgModule/);
        });
    });
    describe('findModuleFromOptions', () => {
        ...
        it('should find a module', () => {
            ...
            const modPath = (0, find_module_1.findModuleFromOptions)(tree, options);
        ...
        it('should find a module using custom ext', () => {
            ...
            expect(() => (0, find_module_1.findModuleFromOptions)(tree, options)).toThrowError(/Specified module 'app' does not exist/);
            // Should not find module if using default ext
        ...
        it('should ignore custom ext if module or ${module}.ts exists', () => {
            ...
            options.module = 'app.module.ts';
            modPath = (0, find_module_1.findModuleFromOptions)(tree, options);
    ...
    describe('buildRelativePath', () => {
        it('works', () => {
            expect((0, find_module_1.buildRelativePath)('/test/module', '/test/service')).toEqual('./service');
            expect((0, find_module_1.buildRelativePath)('/test/module', '/other/service')).toEqual('../other/service');
            expect((0, find_module_1.buildRelativePath)('/module', '/test/service')).toEqual('./test/service');
            expect((0, find_module_1.buildRelativePath)('/test/service', '/module')).toEqual('../module');
        });
    });
});
