...
exports.buildRelativePath = exports.findModule = exports.findModuleFromOptions = exports.ROUTING_MODULE_EXT = exports.LAYOUT_EXT = exports.FEATURE_EXT = exports.LAYER_EXT = exports.MODULE_EXT = void 0;
const core_1 = require("@angular-devkit/core");
exports.MODULE_EXT = '.module.ts';
exports.LAYER_EXT = '.layer.ts';
exports.FEATURE_EXT = '.feature.ts';
exports.LAYOUT_EXT = '.layout.ts';
...
function findModuleFromOptions(host, options) {
    ...
    if (!options.module) {
        ...
        const moduleLayerPath = (0, core_1.normalize)(`/${options.path}/${options.layer}/${options.module}`);
        ...
        for (let dir = moduleLayerPath; dir != core_1.NormalizedRoot; dir = (0, core_1.dirname)(dir)) {
        ...
        for (const c of candidatesDirs) {
            const candidateFiles = [
                ...
                `${moduleBaseName}${exports.LAYER_EXT}`,
                `${moduleBaseName}${exports.FEATURE_EXT}`,
                `${moduleBaseName}${exports.LAYOUT_EXT}`,
